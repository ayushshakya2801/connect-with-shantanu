...
const Callsection = () => {
    return (
        <div className='' >
           ...
           <div>
                <h1 className='text-3xl font-bold w-[600px] text-center' >Unlock Your Past, Reclaim Your Strength and Embrace Emotional Freedom</h1>
            </div>
           </div>
            <div className='flex flex-col lg:flex-row justify-evenly w-full  mt-4 bg-black '>
                {/* Video Section */}
